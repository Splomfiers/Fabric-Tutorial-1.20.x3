...
public class FaerieAttackGoal extends MeleeAttackGoal {
    private final FaerieEntity entity;
    ...
    public FaerieAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((FaerieEntity) mob);
    }
